...
"}"));
        ...
        gridLayout->addWidget(Button_Cos, 5, 1, 1, 1);
        ...
        gridLayout->addWidget(Button_0, 4, 3, 1, 1);
        ...
        gridLayout->addWidget(Button_Tan, 5, 2, 1, 1);
        ...
        gridLayout->addWidget(Button_Divide, 2, 4, 1, 1);
        ...
        gridLayout->addWidget(Button_Sin, 5, 0, 1, 1);
        ...
        gridLayout->addWidget(Button_MR, 1, 1, 1, 1);
        ...
        gridLayout->addWidget(Button_Point, 3, 3, 1, 1);
        ...
        gridLayout->addWidget(Button_AC, 1, 0, 1, 1);
        ...
        gridLayout->addWidget(Button_MC, 1, 2, 1, 1);
